...
```
docker run -e NFS_LOG_LEVEL=DEBUG ... jatinkartik/nfs-server
```
...
---->   /nfs/homes/jatinkartik *(rw,no_subtree_check,insecure,no_root_squash,sec=krb5p)
...
----> starting rpcbind
----> starting exportfs
exporting *:/nfs/homes/jatinkartik
...
rpc.idmapd: static_getpwnam: name 'jatinkartik@HOUGH.MATIS' mapped to 'jatinkartik'
...
rpc.idmapd: static_getgrnam: group 'jatinkartik@HOUGH.MATIS' mapped to 'jatinkartik'
...
----> list of container exports:
---->   /nfs/homes/jatinkartik       *(rw,sync,wdelay,hide,nocrossmnt,insecure,no_root_squash,no_all_squash,no_subtree_check,secure_locks,acl,no_pnfs,anonuid=65534,anongid=65534,sec=krb5p,rw,insecure,no_root_squash,no_all_squash)
